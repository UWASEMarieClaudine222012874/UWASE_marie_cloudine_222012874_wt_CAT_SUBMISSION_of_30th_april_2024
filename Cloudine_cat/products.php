...
<input type="Submit" name="Add" value="Insert"><br><br>
 ...
 <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO products(id,product_name,boxes,amount,date_added) VALUES (?, ?, ?, ?, ?,)");
        $stmt->bind_param("sssss", $id , $product_name, $boxes, $amount, $date_added);
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td>" . $row['date_added'] . "</td>
                     ...
                     <td><a style='padding: 4px;' 
                     
                    href='update_products.php?id=". $row['id']."'>UPDATE</a></td><td><a href='delete_products.php?id=". $row['id']."'>DELETE</a></td>
