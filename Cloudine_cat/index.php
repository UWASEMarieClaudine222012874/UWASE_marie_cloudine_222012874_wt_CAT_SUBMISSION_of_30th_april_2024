...
<body style="background-image: url('./Images/iny.png');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: darkcyan;">inyange_enterprise</h1>
