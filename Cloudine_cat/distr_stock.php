...
<input type="product_id" id="product_id" name="product_id" required><br><br>
 ...
 <?php
   include('connection.php');
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO distr_stock(id, product_name, product_id, amount) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $id , $name, $product_id, $amount);
...
<body>
    <h2 style="text-align: center;">distr_stock Table</h2>
    <table border="1">
        <tr>
            <th>id</th>
            <th>product_name</th>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td><a style='padding: 4px;' href='update_distr_stock.php?id=$id'>Update</a></td>
                    <td><a style='padding: 4px;' href='delete_distr_stock.php?id=$id'>Delete</a></td> 
